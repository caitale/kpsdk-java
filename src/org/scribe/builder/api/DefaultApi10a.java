...
public abstract class DefaultApi10a implements Api {
	...
	public abstract Verb getApiVerb();
	
	public abstract String getApiUrl(String method);
	
	public ApiResponseExtractor getApiResponseExtractor() {
		return new ApiResponseExtractorImpl();
	}
}
