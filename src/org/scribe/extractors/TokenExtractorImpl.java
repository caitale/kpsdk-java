...
{
  private static final Pattern TOKEN_REGEX = Pattern.compile("\"oauth_token\":\\s*?\"(\\S*?)\"");
  private static final Pattern SECRET_REGEX = Pattern.compile("\"oauth_token_secret\":\\s*?\"(\\S*?)\"");
